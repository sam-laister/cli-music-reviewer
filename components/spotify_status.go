...
func NewSpotifyStatus(spotifyHandler services.SpotifyHandler, httpHandler services.HttpHandler) *SpotifyStatusModel {
...
// already stored.
func (m *SpotifyStatusModel) connect() tea.Msg {
